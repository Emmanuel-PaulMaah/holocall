...
- **Optimized bitrates** - LiveKit-recommended encoding for smooth webcam streaming:
  - 360p: 600 kbps (low bandwidth)
  - 720p: 1 Mbps (smooth HD)
  - 1080p: 2 Mbps (smooth Full HD)
- **Ideal constraints** - Camera constraints use ideal/min ranges for better device compatibility
- **Simulcast enabled** - Three quality layers automatically generated by LiveKit for adaptive streaming
...
- **Free tier compatible** - Bitrates optimized for LiveKit Cloud's free tier (no quality restrictions)
